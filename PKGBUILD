...
pkgbase=linux-PARANOIZE
pkgver=5.19.2
pkgrel=1
pkgdesc='Linux PARANOIZE'
url="https://github.com/zen-kernel/zen-kernel/archive/refs/heads/5.19/master.zip"
arch=(x86_64)
license=(GPL2)
makedepends=(
...
options=('!strip')
_srcname=zen-kernel-5.19-master
source=(
  "https://github.com/zen-kernel/zen-kernel/archive/refs/heads/5.19/master.zip"
  config
  Makefile         # the main kernel config file
)
validpgpkeys=(
  ...
  'DA01B4CB62591392EA4B0D9325056AD4B82B6AD6'  # Entropic Raven <22600240+KiRZCH@users.noreply.github.com>
)
...
_package-headers() {
  ...
  cp -vt "$builddir" -a include
  cp -vt "$builddir/arch/x86" -a arch/x86/include
